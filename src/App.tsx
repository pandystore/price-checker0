...
const FLOATY = [
  { t: "أحذية -30%", c: "#dc2626", rot: -8 },
  { t: "وفّرت 70 جنيه", c: "#15803d", rot: 6 },
  { t: "QR Code", c: "#2563eb", rot: -4 },
  { t: "باركود", c: "#7c3aed", rot: 9 },
  { t: "خصم خاص", c: "#f59e0b", rot: -10 },
];
...
export default function App() {
  ...
  return (
    <div
      style={themeVars}
      className="dots-bg relative min-h-screen overflow-x-hidden bg-[#fffdf5]"
    >
      ...
      {/* منطقة العمل: إما الفاتورة أو خانة البحث */}
      {result ? (
        <PriceResult
      ...
      <AdminPanel
        ...
        store={store}
        onOpenGithubGuide={() => setShowGithubGuide(true)}
      />
